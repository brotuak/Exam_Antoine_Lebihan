...
type Task struct { //1.3
	Description string
	Done        bool
}

var task []Task // variable globale, slice de Task
...
func list(rw http.ResponseWriter, _ *http.Request) {
	...
	return concac // on retourne la chaine de caracatère concaténer
}
...
func main() { // 
	fmt.Println()
	http.ListenAndServe("localhost:4000", nil) // Lancement du serv HTTP
